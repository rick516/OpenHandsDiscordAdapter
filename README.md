...
# OpenHands Discord Integration

This project integrates OpenHands with Discord, allowing users to interact with OpenHands through a Discord bot.

## Features

- Command-based interaction with OpenHands
- Conversation-based interaction with OpenHands
- Project management through Discord
...
- `!oh help` - Show help message

### Conversation

You can also interact with OpenHands in a conversation by sending messages in a DM or in a channel named `openhands-chat`.
